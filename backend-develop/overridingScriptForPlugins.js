...
""+'\n'+
"Service.makeModule.{{MODEL_NAME}} = new serviceModule(require('./{{MODEL_NAME}}'));"+'\n'+
...
"var Joi = require('joi');"+"\n"+
""+"\n"+
"Controller.makeModule.{{MODEL_NAME}} = require('./{{MODEL_NAME_CAP}}Controller').{{MODEL_NAME}}"+"\n"+
