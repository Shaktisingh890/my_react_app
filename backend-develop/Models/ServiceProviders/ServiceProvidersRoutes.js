...
function ServiceProvidersRoute(controller, requestSchema, mainKey, subKey , payload) {
...
ServiceProvidersRoute.prototype = Object.create(routesModule.prototype) // inheritance happening


ServiceProvidersRoute.prototype.getParentRoutes = ServiceProvidersRoute.prototype.getRoutes;
//ServiceProvidersRoute.prototype.overridedParantFunction = ServiceProvidersRoute.prototype.ParantFunction;


ServiceProvidersRoute.prototype.newFunction = function(request, reply){
...
ServiceProvidersRoute.prototype.getRoutes = function(request, reply) {
...
module.exports = {
    'serviceProviders': new ServiceProvidersRoute(Controller.makeModule.serviceProviders, schema, 'admins', 'serviceProviders')
};
